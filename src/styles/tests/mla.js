...
const HTML = [
  ...
  },
  {
    ...
    '<section id="bibliography">'+
      '<ol class="bibliography-list">'+
        '<li id="doe84">Doe, Jon. <i>The title</i>. 1984.</li>'+
      '</ol>'+
    '</section>',
  },
  {
    ...
    '<section id="bibliography">'+
      '<ol class="bibliography-list">'+
        '<li id="doe84">Doe, Jon. <i>The title</i>. Cambridge, MA: MIT Press, 1984.</li>'+
      '</ol>'+
    '</section>',
  },
  {
    ...
    '<section id="bibliography">'+
      '<ol class="bibliography-list">'+
        '<li id="doe84">Doe, Jon. <i>The title</i> (3rd ed.). Jane Doe &amp; Henry Smith (Ed(s).). Cambridge, MA: MIT Press, 1984. </li>'+
      '</ol>'+
    '</section>',
  },
  {
    ...
    '<section id="bibliography">'+
      '<ol class="bibliography-list">'+
        '<li id="doe84">Doe, Jon. <i>The title</i> '+
        '(Harry Baker &amp; Tom Jones, Trans.), (3rd ed.).'+
        'Jane Doe &amp; Henry Smith (Ed(s).). Cambridge, MA: MIT Press, 1984.</li>'+
      '</ol>'+
    '</section>',
  }
]
...
module.exports = function () {
  ...
  HTML.forEach((pair, index) => {
    let input = (
      '<citation doe84 />'+
      '<bibliography mla>['+ pair.bib +']</bibliography>'
    )
